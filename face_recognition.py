...
class Face_Recognition:
    def __init__(self,root):
        ...
        title_lbl=Label(text="Face_Recognition",font=("times new roman",35,"bold"),bg="white",fg="#000080")
        title_lbl.place(x=0,y=0,width=1530,height=47)

        #1st image
        img_top=Image.open(r"D:\Users\Mohd Afzal\Desktop\face recognition system\college_images\face_detector1.jpg")
        img_top=img_top.resize((650,700),Image.Resampling.LANCZOS)
        self.photoimg_top=ImageTk.PhotoImage(img_top)

        lbl=Label(image=self.photoimg_top)
        lbl.place(x=0,y=55,width=650,height=700)


        #2nd image            
        img_bottom=Image.open(r"D:\Users\Mohd Afzal\Desktop\face recognition system\college_images\facial_recognition_system_identification_digital_id_security_scanning_thinkstock_858236252_3x3-100740902-large.jpg")
        img_bottom=img_bottom.resize((950,700),Image.Resampling.LANCZOS)
        self.photoimg_bottom=ImageTk.PhotoImage(img_bottom)

        f_lbl=Label(image=self.photoimg_bottom)
